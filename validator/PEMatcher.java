...
/**
 * This class implements a Preconditional and Result matchers based on Pallouci's works.
 * 
 * @author Lorena Edens
 * @version 0.1
 */
...
//					Get the smallest degree of math between the predicate and arguments
	...
	@Override
	public void matcher(ArrayList<pf.vo.Service> services, pf.vo.Query request) {
