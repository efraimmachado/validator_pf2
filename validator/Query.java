...
/**
 * Class that contains the attributes of a Query.
 */
public class Query {
	/**
	 ...
	 */
	public Query(ArrayList<URI> inputList, ArrayList<URI> outputList, URI uri) {
	 ...
	 * @param uri - Attribute with the URI of the service.
	 */
	public Query(ArrayList<URI> inputList, ArrayList<URI> outputList, ArrayList<ArrayList<URI>> preconditionList, 
